...
namespace TobbbformosPizzaAlkalmazasTobbTabla.Model
{
    partial class Courier
    {
        ...
        public Courier(int id, string name, string tel)
        {
            ...
            if (!isValidName(name))
            {
                throw new ModelFutarNotValidNameExeption("A futár neve nem megfelelő (nagy betűvel kezdje) !");
            }

            if (!isValidTel(tel))
            {
                throw new ModelFutarNotValidNameExeption("A telefonszám nem megfelelő (pl: +36701234567) !");
            }
        }
